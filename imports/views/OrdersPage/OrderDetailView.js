  ...
  getOrderDetails() {
    ...
    return (
      <div className="order-detail__container">
        ...
        <div className="order-detail__subsection">
          <h5 className="order-detail__accountName">
            {account ? account.name : '[삭제된 업체]'}
          </h5>
          <h4 className="order-detail__productName">
        ...
        {product &&
          product.isPrint && (
            <div className="order-detail__subsection">
              ...
              <p className="order-detail__description">
                {product && product.printMemo}
              </p>
              <img
                className="order-detail__print-image"
                src={product && product.printImageURL}
